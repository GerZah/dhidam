...
<?php
  ...
  if ($result) {
    ...
    switch ($result) {
      case 9: $msg = "$err User could not be created."; break;
      case 8: $msg = "$err Application Administrator may not create a user of this role."; break;
      case 7: $msg = "$err Technical Administrator may not create a user of this role."; break;
      case 6: $msg = "$err Super Administrator may not create a user of this role."; break;
      case 5: $msg = "$err Password may not be left blank."; break;
      case 4: $msg = "$err E-mail adddress already in use."; break;
      case 3: $msg = "$err E-mail address may not be left blank."; break;
      case 2: $msg = "$err User name already exists."; break;
      case 1: $msg = "$err User name may not be left blank."; break;
    }
  ...
  if (in_array($result, [1,2])) { $usernameAttr["autofocus"] = 1; }
  ...
  if (in_array($result, [3,4])) { $emailAttr["autofocus"] = 1; }
  ...
  if (in_array($result, [5])) { $passwordAttr["autofocus"] = 1; }
  ...
  if (in_array($result, [6,7,8])) { $roleAttr["autofocus"] = 1; }
